...
import { Fn, CfnCondition } from 'aws-cdk-lib';
...
export function createVpcResources(scope: Construct, envType: string, vpcLocationId: number, prodCondition: CfnCondition): VpcResources {
  ...
  const subnetPublicA = new ec2.CfnSubnet(scope, 'SubnetPublicA', {
    ...
    cidrBlock: { "Fn::Select": [0, { "Fn::Cidr": [ { "Fn::GetAtt": [vpc.logicalId, "CidrBlock"] }, 256, 8 ] }] } as any,
  ...
  const subnetPublicB = new ec2.CfnSubnet(scope, 'SubnetPublicB', {
    ...
    cidrBlock: { "Fn::Select": [1, { "Fn::Cidr": [ { "Fn::GetAtt": [vpc.logicalId, "CidrBlock"] }, 256, 8 ] }] } as any,
  ...
  const subnetPrivateA = new ec2.CfnSubnet(scope, 'SubnetPrivateA', {
    vpcId: vpc.ref,
    availabilityZone: { "Fn::Select": [0, { "Fn::GetAZs": { "Ref": "AWS::Region" } }] } as any,
    cidrBlock: { "Fn::Select": [2, { "Fn::Cidr": [ { "Fn::GetAtt": [vpc.logicalId, "CidrBlock"] }, 256, 8 ] }] } as any,
  ...
  const subnetPrivateB = new ec2.CfnSubnet(scope, 'SubnetPrivateB', {
    vpcId: vpc.ref,
    availabilityZone: { "Fn::Select": [1, { "Fn::GetAZs": { "Ref": "AWS::Region" } }] } as any,
    cidrBlock: { "Fn::Select": [3, { "Fn::Cidr": [ { "Fn::GetAtt": [vpc.logicalId, "CidrBlock"] }, 256, 8 ] }] } as any,
